...
#include "../../MedicineDb/calendardelegate.h"
...
struct qt_meta_stringdata_CalendarDelegate_t {
    QByteArrayData data[1];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CalendarDelegate_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CalendarDelegate_t qt_meta_stringdata_CalendarDelegate = {
    {
...
const QMetaObject CalendarDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_CalendarDelegate.data,
      qt_meta_data_CalendarDelegate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalendarDelegate.stringdata))
